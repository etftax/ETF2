...
export const metadata: Metadata = {
  ...
  keywords: [
    "declaratia unica 2026",
    "completare declaratie unica",
    "declaratie unica pfa",
    "declaratie unica chirii",
    "declaratie unica ANAF",
    "declaratie unica online",
    "completare declaratie unica online",
    "termen declaratie unica 2026",
    "declaratie unica 2026 termen",
...
const jsonLdFaq = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Persoanele fizice cu venituri din chirii, activități independente (PFA/II/IF), dividende, dobânzi, venituri din străinătate, cripto, drepturi de proprietate intelectuală sau alte venituri impozabile.",
      },
    },
    {
      "@type": "Question",
...
export default function DeclaratieUnicaPage() {
  return (
    <main className="min-h-screen">
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLdRating) }}
      />
