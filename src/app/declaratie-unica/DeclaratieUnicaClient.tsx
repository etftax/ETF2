            ...
            <div className="du-container">
              ...
              <div className="du-whyus-grid">
                ...
                <div className="du-whyus-card">
                  ...
                  <p>Nu te lăsăm să aștepți zile întregi. Suni acum, vorbim cu tine în maxim 30 minute lucrătoare.</p>
                </div>
              </div>
          ...
          <section className="du-section">
            <div className="du-container">
              ...
              <div className="du-scarcity-real">
                ...
                <p><strong>Acum:</strong> răspundem în maxim 30 min, declarația în aceeași zi.</p>
