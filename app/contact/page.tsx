            ...
            <div>
              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Str. Sărafinești 16, Sector 2, București</p>
                  </div>
                </div>
              ...
              <div className="bg-card rounded-lg p-6 border border-border">
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <p><strong className="text-foreground">Adresă:</strong> Str. Sărafinești 16, Sector 2, București</p>
                </div>
              </div>
            </div>
