...
export const metadata: Metadata = {
  title: "Despre Noi | Evolution Tax Finance - Experți în Contabilitate",
  description: "Echipă de profesioniști cu experiență în contabilitate și fiscalitate. Misiunea noastră: soluții financiare clare și conforme pentru afacerea ta.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    ...
    description: "Echipă de profesioniști cu experiență în contabilitate și fiscalitate.",
    type: "website",
    locale: "ro_RO",
  },
};
