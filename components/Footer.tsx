...
const footerLinks = {
  servicii: [
    ...
    { name: "Audit", href: "/servicii#audit" },
    { name: "Suport Juridic", href: "/servicii#juridic" },
  ],
  companie: [
  ...
  legal: [
    { name: "ANAF-SOL", href: "https://consumer-redress.ec.europa.eu/dispute-resolution-bodies_en?prefLang=ro", external: true },
    { name: "ANAF-SAL", href: "https://reclamatiisal.anpc.ro/", external: true },
  ],
};
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-primary-foreground/60 text-sm leading-relaxed mb-4">
              Servicii profesionale de contabilitate, fiscalitate și consultanță
              financiară pentru companii din România.
            </p>
          ...
          {/* Servicii */}
          <div>
            <h4 className="text-primary-foreground font-medium mb-4">Servicii</h4>
          ...
          {/* Companie & ANAF */}
          <div>
            <h4 className="text-primary-foreground font-medium mb-4">Companie</h4>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-primary-foreground/60">
              ...
              <p>
                <strong className="text-primary-foreground">Telefon:</strong>
                <br />
                <a
                  href="tel:+40744364603"
                  className="hover:text-primary-foreground transition-colors"
              ...
              <p>
                <strong className="text-primary-foreground">Program:</strong>
                <br />
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-primary-foreground/40 text-sm">
            © {new Date().getFullYear()} Evolution Tax Finance SRL. CUI: 35486370. Toate drepturile
            rezervate.
          </p>
